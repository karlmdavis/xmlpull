...
import org.xmlpull.v1.dom2_builder.TestDOM2XmlPullBuilder;
import org.xmlpull.v1.tests.UtilTestCase;
import org.xmlpull.v1.wrapper.TestXmlPullWrapper;
 ...
 */
public class AllXmlPullAddonsTests extends TestRunner {
    private static boolean runAll;
    
    public static boolean runnigAllTests() { return runAll; }
    
    public AllXmlPullAddonsTests() {
        super();
    }
    
    public static Test suite() {
        TestSuite suite = new TestSuite("XmlPull V1 ADDONS TESTS");
        
        suite.addTestSuite(TestDOM2XmlPullBuilder.class);
        suite.addTestSuite(TestXmlPullWrapper.class);
        return suite;
    }
    ...
    public static void addNote(String note) {
        if(AllXmlPullAddonsTests.runnigAllTests() == false) {
    ...
    public void runAllXmlPullAddonsTests(String testFactoryName) {
        //writer()
    ...
    public static void main (String[] args) {
        final AllXmlPullAddonsTests driver = new AllXmlPullAddonsTests();
        ...
        if(listOfTests != null) {
            ...
            while (pos < listOfTests.length()) {
                ...
                driver.runAllXmlPullAddonsTests(testFactoryName);
                pos = cut + 1;
            }
            driver.printFinalReport();
            
        } else {
            driver.runAllXmlPullAddonsTests(null);
        }
        System.exit(0);
    }
